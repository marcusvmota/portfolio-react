    ...
    <main>
      ...
      <div className="contact" id="contato">
        <img
          className="retangulo"
          src={retangulo}
          alt="retangulo usado para juntar texto com os icones das redes sociais"
        />
        <img
          className="elipse"
          src={elipse}
          alt="elipse com destaque ao nome contact me now"
        />
        <div className="icones">
          <a href="https://www.instagram.com/viniciusqmota/" target="_blank">
            {" "}
            <img src={instagram} alt="icone do instagram" />{" "}
          </a>
          <a href="https://github.com/marcusvmota" target="_blank">
            {" "}
            <img src={github} alt="icone do github" />{" "}
          </a>
          <a
            href="https://www.linkedin.com/in/marcus-vinicius-mota"
            target="_blank"
          >
            {" "}
        ...
        <div className="contact_frase">
          {" "}
          Contact <br /> <spam>me now!</spam>
        </div>
      </div>
